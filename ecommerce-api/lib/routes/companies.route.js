...
exports.companyRoutes.post("/companies", (0, celebrate_1.celebrate)({ [celebrate_1.Segments.BODY]: company_model_1.companySchema }), (0, express_async_handler_1.default)(companies_controller_1.CompaniesController.save));
exports.companyRoutes.put("/companies/:id", (0, celebrate_1.celebrate)({ [celebrate_1.Segments.BODY]: company_model_1.companySchema }), (0, express_async_handler_1.default)(companies_controller_1.CompaniesController.update));
